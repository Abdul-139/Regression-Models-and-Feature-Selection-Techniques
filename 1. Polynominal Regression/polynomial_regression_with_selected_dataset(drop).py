# -*- coding: utf-8 -*-
"""Polynomial Regression with selected dataset(drop)

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Yt8z9E4oA7PU8FQUbzh3EU6nGTU54pju
...
"""In the realm of Recursive Feature Elimination (RFE) analysis, the significance of features is gauged through their respective rankings. A lower rank denotes higher importance for predicting model outcomes. In this RFE exploration, **heavycnt, hbonddonor and rotbonds** all share the coveted rank of 1, underscoring their paramount importance in shaping the model's predictive prowess."""
